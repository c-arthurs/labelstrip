# this was stolen from the below set of scropts and used as a wrapper around the thing
...
class TiffEntry(object):
    ...
    def value(self):
        ...
        if self.type == ASCII:
            ...
            items = tuple([i.decode('utf-8') for i in list(items)])
            return ''.join(items[:-1])
        else:
            return items
...
if __name__ == '__main__':
    _main(name = "/Users/callum/Desktop/stripname/MPM19-01_A13_R_ACE2 3.svs")
